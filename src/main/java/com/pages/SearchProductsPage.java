...
public class SearchProductsPage extends BasePage {
    ...
    public void clickInsuranceTab() {
        waitForElementClickable(driver, By.xpath(InsuranceTab), DefaultProfile.WAIT_PRESENT_TIMEOUT);
        click(driver, By.xpath(InsuranceTab));
    }

    public void clickCarTab() {
        waitForElementClickable(driver, By.xpath(CarTab), DefaultProfile.WAIT_PRESENT_TIMEOUT);
